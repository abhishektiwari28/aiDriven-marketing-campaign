        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Strategic intelligence and deployment console</p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative group">
                        ...
                        <select
                            ...
                            className="bg-white border border-slate-200 rounded-xl py-2.5 pl-10 pr-10 text-sm font-bold text-slate-700 focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/5 transition-all appearance-none cursor-pointer hover:border-slate-300 min-w-[200px]"
                        >
                            {campaigns.map(c => (
            ...
            {/* Tabbed Navigation */}
            <div className="bg-white p-1 rounded-2xl flex overflow-x-auto border border-slate-200 shadow-sm shadow-slate-200/50">
                {tabs.map((tab) => (
                    <button
                        key={tab.id}
